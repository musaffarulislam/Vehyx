        ...
        <div className='w-full h-full flex justify-center'>
          <div className='mx-12 flex justify-between'>
            <div className="w-1/2 flex flex-col justify-center text-white">
              <h1 className="text-4xl md:text-6xl font-semibold mb-6"><span className='text-primary'>India’s #1</span> platform</h1>
              <h1 className="text-4xl md:text-6xl font-semibold mb-6">for Vehicle History</h1>
