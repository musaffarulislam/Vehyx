    ...
    <>
      <div className="text-center py-4">
        ...
        <h3 className="font-light text-base">
          Get the VEHYX History-Based value to find out what your car is really
          worth.
        </h3>
      </div>
      <div className="my-4 w-full lg:w-3/5 drop-shadow-default  rounded-2xl bg-white p-12 py-16 flex flex-col gap-6">
        <div className="flex gap-4 w-full">
          <div className="grid gap-2 w-full">
            <Label htmlFor="zip-code" className="text-black">
              Enter your Zip Code*
            </Label>
            <InputForm
              placeholder="Enter your car worth"
        ...
        <div className="flex gap-4 w-full">
          <div className="grid gap-2 w-full">
            <Label htmlFor="plate" className="text-black">
        ...
        <Button className="w-full bg-gradient-mixture text-white rounded-lg">
          Get Value
        </Button>
      </div>
    </>
