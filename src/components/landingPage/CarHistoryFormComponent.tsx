...
const CarHistoryFormComponent = () => {
  ...
  const cards = [
    ...
    {
      color: "bg-pink-100",
      icon: <HistoryCardIcon2 />,
      status: "Accidents",
      carModel: "2017 Maruthi Shift",
      historyValue: "1,85,200 Rs.",
    },
    {
      color: "bg-blue-100",
      icon: <ApproveIconComponent />,
      status: "VEHYX 1 - Owner",
      carModel: "2015 Toyota Camry SE",
      historyValue: "2,75,900 Rs.",
    },
    {
      color: "bg-pink-100",
      icon: <OwnerIconComponent />,
      status: "3 Owners",
      carModel: "2021 KIA Seltos",
      historyValue: "2,10,450 Rs.",
    },
    {
      color: "bg-blue-100",
      icon: <OilIconComponent />,
      status: "Regular Oil Changes",
      carModel: "2012 Toyota Camry SE",
      historyValue: "2,62,800 Rs.",
    },
    {
      color: "bg-pink-100",
      icon: <QuestionIconComponent />,
      status: "No Reports Service Records",
      carModel: "2017 Maruthi Shift",
      historyValue: "1,95,320 Rs.",
    },
  ];
  ...
  const cardsPerPage = isLargeScreen ? 2 : 1;
    ...
    <div className="w-full">
      <div className="text-center py-4">
        ...
        <h3 className="font-light text-base">
          See the price differences for yourself
        </h3>
      </div>
