...
const HistorySection = () => {
  return (
    <div
      id="registration"
      className="w-full flex flex-col gap-8 items-center  rounded-xl"
    >
      ...
      <div className="w-full flex flex-col gap-8 bg-prinwkle border border-marian p-8 rounded-xl">
        ...
        <div className="flex flex-col gap-4">
          <span className="text-lg">
            This vehicle has been registered in the province
            of Ontario in Canada with Normal branding.
          </span>
          <span>
            <span className="font-bold">We checked for: </span>Inspection
            Required, Normal, Non-repairable, Rebuilt, Salvage and Stolen.
          </span>
        </div>
      </div>
    </div>
