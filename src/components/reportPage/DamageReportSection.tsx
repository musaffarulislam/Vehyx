      ...
      <table className="w-full rounded-xl overflow-hidden border border-platinum">
        <thead>
          <tr className="text-white bg-marian">
            <th className="w-1/4 p-4 text-left border-r border-platinum">
              Incident Date
            </th>
            <th className="w-2/4 p-4 text-left border-r border-platinum">
              Details
            </th>
        ...
        <tbody className="border border-platinum">
          <tr className="border-b border-platinum text-sm">
            <td className="w-1/4 p-4 border-r border-platinum py-8 font-bold">
              2017 Apr 24
            </td>
