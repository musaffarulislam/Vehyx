  ...
  return (
    <div className="w-96 p-6 px-8">
      ...
      <div className="border-b border-tertiary border-opacity-50">
        ...
        {expandedSections.location && (
          <div className="flex gap-2 items-center py-2">
            ...
            <span className="text-gray-400 text-center text-sm">Miles of</span>
            <div className="relative w-1/2">
              <select className="appearance-none border rounded-md p-2 w-full bg-white text-sm">
      ...
      {filterOptions.map((option, index) => (
        <div key={option.id} className={`${filterOptions.length-1 !== index && 'border-b border-tertiary border-opacity-50'} py-4`}>
          <div 
