  ...
  return (
    <nav className="flex justify-between items-center">
      ...
      <ul className="flex space-x-12 text-white font-medium">
        <li
          className={clsx("hover:text-primary font-medium cursor-pointer", {
        ...
        <li
          ...
          onClick={() => handleRouteChange("/report")}
        >
          Services
        </li>
        <li
          ...
          onClick={() => handleRouteChange("/lists")}
        >
          Marketplace
        </li>
        <li
      ...
      {/* Buttons */}
      <div className="max-lg:hidden flex space-x-4 font-medium">
