    ...
    <div className="w-full flex justify-between">
      <div className="flex flex-col gap-4">
        <div className="flex  gap-2 md:gap-4">
          ...
          <Link href="/lists/details" className="flex items-center text-blue-700 underline">Buy VEHYX History Report</Link>
        </div>
        <div className="flex gap-2 md:gap-4">
          <div className="flex gap-2 items-center justify-center">
          <Image src={LocationIcon} alt="LocationIcon" width={40} height={40} className="w-5 h-5" />
            <p className="text-tertiary"><span className="font-bold">Coldbrook</span> <span>953 km + Delivery available</span></p>
          </div>
      ...
      <div className="flex justify-end">
        ...
        <div className="bg-green-700 rounded-full px-4 py-3 h-fit text-white">Great Price</div>
        </div>
      </div>
    </div>
  )
